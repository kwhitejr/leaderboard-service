...
class TestEndToEndWorkflows:
    ...
    def test_error_recovery_workflow(self, leaderboard_db, lambda_context):
        ...
        requests = [
            ...
            {
                "valid": True,
                "data": {"game_id": game_id, "initials": "VLD", "score": 1000.0, "score_type": "high_score"}
            },
            # Invalid request - bad score type
            {
                "valid": False,
                "data": {"game_id": game_id, "initials": "BAD", "score": 1500.0, "score_type": "invalid_type"}
            },
            # Valid request
            {
                "valid": True,
                "data": {"game_id": game_id, "initials": "OK2", "score": 2000.0, "score_type": "high_score"}
            },
            # Invalid request - negative score
            {
                "valid": False,
                "data": {"game_id": game_id, "initials": "NEG", "score": -100.0, "score_type": "high_score"}
            },
            # Valid request
            {
                "valid": True,
                "data": {"game_id": game_id, "initials": "OK3", "score": 1800.0, "score_type": "high_score"}
            },
        ]
