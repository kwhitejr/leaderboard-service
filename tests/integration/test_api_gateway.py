...
class TestAPIGatewayIntegration:
    ...
    def test_submit_score_success(
        ...
        leaderboard_db, 
        lambda_context, 
        sample_score_data: Dict[str, Any]
    ):
    ...
    def test_get_leaderboard_success(self, leaderboard_db, lambda_context, sample_score_data):
    ...
    def test_multiple_score_submissions_and_ranking(self, leaderboard_db, lambda_context):
        """Test multiple score submissions and proper ranking."""
        game_id = "ranking_test_game"
        scores_data = [
            {"game_id": game_id, "initials": "P1", "score": 1000, "score_type": "high_score"},
            {"game_id": game_id, "initials": "P2", "score": 2000, "score_type": "high_score"},
            {"game_id": game_id, "initials": "P3", "score": 1500, "score_type": "high_score"},
        ]
    ...
    def test_cors_headers_present(self, leaderboard_db, lambda_context, sample_score_data):
