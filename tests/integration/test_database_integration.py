...
class TestDatabaseIntegration:
    ...
    def test_submit_and_retrieve_single_score(self, leaderboard_db: LeaderboardDatabase):
    ...
    def test_multiple_scores_ranking_high_score(self, leaderboard_db: LeaderboardDatabase):
    ...
    def test_multiple_scores_ranking_fastest_time(self, leaderboard_db: LeaderboardDatabase):
    ...
    def test_multiple_scores_ranking_longest_time(self, leaderboard_db: LeaderboardDatabase):
    ...
    def test_get_all_score_types_for_game(self, leaderboard_db: LeaderboardDatabase):
        ...
        # Submit scores for different types
        scores = [
            ScoreRecord(game_id=game_id, initials="H1", score=1000.0, score_type=ScoreType.HIGH_SCORE),
            ScoreRecord(game_id=game_id, initials="F1", score=60.5, score_type=ScoreType.FASTEST_TIME),
        ]
    ...
    def test_timestamp_ordering_with_identical_scores(self, leaderboard_db: LeaderboardDatabase):
